...
"year": 2022},
    ...
    {"name": "Azul párbaj", "players": (2, 2), "duration": "15–30 perc", "complexity": "egyszerű",
     ...
     "description": "Két csapat, egy cél: vajon ki teljesíti hamarabb? Ki a jobb szóalkotó? Már csak egy kamra választ el minket a szörnytől... Itt a varázsszó, ami nyitja, de vajon milyen csapdákkal védte le a másik csapat?!", "mechanisms": ["aszimmetrikus", "kártya-képes", "kooperatív"],
     "author": "Olivier Latombe",
     "year": 2015},
    {"name": "Zamatkockák", "players": (2, 4), "duration": "15–30 perc", "complexity": "egyszerű",
     ...
     "description": "", "mechanisms": ["aszimmetrikus", "kártya-képes", "kooperatív"],
     "author": "Olivier Latombe",
     "year": 2015},
